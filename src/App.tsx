    ...
    <div id="applet-viewport" className="min-h-screen bg-stone-50 font-sans text-stone-800 antialiased relative selection:bg-stone-200 pb-24 md:pb-0">
      ...
      <section id="product-listings" className="py-20 bg-stone-100/50 border-b border-stone-200/60 relative">
        <div className="max-w-6xl mx-auto px-6 space-y-12">
          ...
          <div className="flex items-center justify-center p-4 bg-white rounded-2xl border border-stone-200 shadow-2xs">
            {/* Search Input */}
            <div className="relative w-full max-w-md flex items-center">
              ...
              <input
                ...
                className="w-full pl-9 pr-8 py-2 rounded-xl bg-stone-50 hover:bg-stone-100/80 focus:bg-white border border-stone-200 focus:border-stone-400 focus:ring-1 focus:ring-stone-400/25 outline-none text-xs transition-all text-stone-800 placeholder-stone-400 font-sans"
              />
              {searchQuery && (
                <button
                  onClick={() => setSearchQuery("")}
                  className="absolute right-3 text-stone-400 hover:text-stone-600 font-sans text-xs cursor-pointer"
                >
                  Clear
                </button>
              )}
